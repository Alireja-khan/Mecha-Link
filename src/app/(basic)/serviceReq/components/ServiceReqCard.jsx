...
const ServiceReqCard = ({ request }) => {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row rounded-2xl shadow-xl overflow-hidden border border-primary transition-all duration-300 hover:shadow-2xl">
        ...
        <div className="flex-1 p-6 md:p-8">
          ...
          <div className=" p-4 bg-orange-200 border-l-4 border-orange-300 rounded-lg">
          ...
          <Link
            href={`/serviceReq/${request._id}`}
            className="flex items-center gap-2 px-5 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-600 transition-colors font-semibold shadow-lg mt-4 justify-center lg:hidden"
          >
            <Eye className="w-4 h-4" />
            View Details
          </Link>
