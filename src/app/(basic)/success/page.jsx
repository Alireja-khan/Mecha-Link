...
export default function SuccessPage() {
  ...
  if (!shopID) {
    return (
      <div className="flex items-center justify-between border-b pb-4  bg-white shadow-lg rounded-xl p-8 w-full max-w-2xl mx-auto my-20">
        <img
          src="/logo.png"
          alt="Company Logo"
        ...
        <div className="text-right">
          <h1 className="text-3xl font-bold text-green-600">Payment Please!</h1>
