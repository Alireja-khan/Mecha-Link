   ...
   return (
       <div className="relative w-full" ref={dropdownRef}>
           ...
           {isOpen && options.length > 0 && (
               <ul className="absolute z-20 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl overflow-y-auto max-h-60">
                   {options.map((option) => (
                       <li
                           key={option}
                           ...
                           <div className="space-y-4">
                               ...
                               <div>
                                   ...
                                   <input 
                                       ...
                                       className="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-orange-500 focus:border-orange-500 bg-gray-100" 
                                       readOnly 
                                   />
