...
import { Users, Rocket, Target, Star, Heart, Wrench, MapPin, Shield, MessageCircle, Clock, TrendingUp, Award, Zap, Calendar, CreditCard } from "lucide-react";
        ...
        <div className="bg-gray-50 text-gray-800">
            ...
            <section className="relative bg-gray-900 text-white py-24 text-center overflow-hidden">
                ...
                <div className="relative max-w-6xl mx-auto px-6">
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold mb-6">About MechaLink</h1>
            ...
            <section className="max-w-6xl mx-auto px-6 py-20">
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        <h3 className="text-2xl font-semibold mb-6">Bridging the Gap Between Mechanics and Customers</h3>
                        <p className="text-lg leading-relaxed mb-6">
                            MechaLink was founded in 2023 with a vision to transform the automotive service industry.
                            We recognized that both mechanics and vehicle owners faced significant challenges in connecting
                            and transacting efficiently.
                        </p>
                        <p className="text-lg leading-relaxed mb-6">
                            Our platform combines the best elements of modern technology with deep industry knowledge
                    ...
                    <div className="grid md:grid-cols-2 gap-10">
                        <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition">
                            ...
                            <p className="text-gray-700">
                                To create a reliable bridge between mechanics and customers by offering transparency,
                                trust, and convenience in every service. We're committed to elevating the standard of
                                automotive repairs through technology and community.
                            </p>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition">
                            ...
                            <p className="text-gray-700">
                                To become the global leader in automotive service technology, redefining customer
                                experience with innovation and care. We envision a world where finding quality
                                automotive service is as easy as ordering food delivery.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-10 items-center">
                        <div className="bg-gray-50 border-2 border-orange-500 p-8 rounded-2xl shadow-md">
                            ...
                            <p className="text-gray-700 mb-6">
                                With a passion for technology and innovation, Alireja founded MechaLink to bridge
                                the gap between skilled mechanics and customers seeking reliable services. His
                        ...
                        <div>
                            ...
                            <p className="text-lg text-gray-700 mb-6">
                                Jhankar assembled a team of passionate developers and industry experts to bring
                                MechaLink to life. His leadership has fostered a culture of innovation and excellence
                ...
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
                        {[
                            ...
                            { name: "Omar Faruk", role: "Full Stack Developer", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" },
                            ...
                            { name: "MD. Rahimul Haq", role: "Backend Engineer", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" },
                            { name: "Raheel Arfeen Rahat", role: "Frontend Developer", image: "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" },
                            { name: "MD. Shahan Al Munim", role: "Backend Engineer", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" },
                        ].map((person, i) => (
                            <div
                                key={i}
            ...
            <section className="py-20 bg-gradient-to-r from-orange-500 to-amber-600 text-white">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <p className="text-xl mb-10 max-w-3xl mx-auto">
                        Whether you're a vehicle owner seeking reliable service or a mechanic looking to grow your business,
